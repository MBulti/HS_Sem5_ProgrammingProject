...
__all__ = ['Recommendation', 'Movie', 'get_all_movies',
           'get_recommendation_for_movie_id']
...
def get_list_of_recommendation(movies: list[int]) -> list[Recommendation]:
    ...
    for movie in movies:
        ...
        movie_recommendations.append(Recommendation(movie_id=movie, recommendations=[
                                     int(f) for f in recommendation[1].split(',')]))
